    ...
    <main>
        <div class="col-md-12 d-flex flex-column align-items-center justify-content-center"
            ...
            <div class="col-md-6 d-flex flex-column align-items-center ">
                <h1 class="fw-bold" style="margin-bottom:0.5em">Entre na sua conta</h1>
                <p class="h3" style="margin-bottom:1em">Faça login pelas redes</p>
                <div class="d-flex align-items-center gap-5 " style="margin-bottom:3em">
                    <div class="icon"><svg fill="#000000" height="2.5em" width="2.5em" version="1.1" id="Capa_1"
                    ...
                    <div style="margin-bottom: 4px" class="icon"><svg width="3.4375em" height="3.4375em"
                    ...
                    <div style="margin-bottom:14px" class="icon"><svg width="2.8125em" height="2.8125em"
                            viewBox="-1.5 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="col-md-6 d-flex justify-content-between mt-3">
                <div class="d-flex flex-column ">
                    <p style="text-decoration: underline; margin-bottom:5px">Esqueci minha senha</p>
